export function Hero() {
  return (
    <section
      id="hero"
      className="relative flex flex-col py-0 sm:py-6 md:py-8 lg:py-12"
    >
      <h2 className="text-3xl md:text-4xl font-medium tracking-tighter gap-2">
        Hi, my name is Kamil
        <span className="font-black text-primary">.</span>
      </h2>
      <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold font-serif tracking-tighter -mt-2">
